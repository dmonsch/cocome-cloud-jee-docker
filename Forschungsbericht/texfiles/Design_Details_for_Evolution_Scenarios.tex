...
\section{Design Decisions for the Mobile App} \label{App} %TODO Zitat, Bild kopiert wie??
...
%TODO Hier muss ein TExt rein, der das Design beschreibt. Ähnlkich zu 5.4.2 aus altem report. DIeser Text muss auf Komponentendiagramm und Sequenzdiagramm verweisen. Beide Digramm aus Schnabels Paper erstellen.
